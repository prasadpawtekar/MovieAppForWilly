    ...
    private static class TagDrawable extends Drawable {
        ...
        public TagDrawable(String text, int tagPadding, float textSize, boolean bold, int textColor, int tagColor, float roundCornersFactor) {
            ...
            setBounds(0, 20,
                    ...
                    (int) (textContentPain.getTextSize() + backgroundPadding.top + backgroundPadding.bottom + 20)
            );
        ...
        public void draw(Canvas canvas) {
            ...
            canvas.drawText(text, backgroundPadding.left + MAGIC_PADDING_LEFT, textContentPain.getTextSize() + 20 + backgroundPadding.top - MAGIC_PADDING_BOTTOM, textContentPain);
        }
